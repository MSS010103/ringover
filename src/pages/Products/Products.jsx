        ...
        <div className="actions-cell">
          ...
          <button onClick={() => handleDeleteProduct(record.id)}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.1483 11.9359C11.1131 12.4611 10.6769 12.869 10.1506 12.869H3.84163C3.31534 12.869 2.87912 12.4611 2.84387 11.936L2.27734 3.49451H11.7142L11.1483 11.9359Z" fill="#AEB9E1" stroke="#AEB9E1" strokeLinecap="round" strokeLinejoin="round"/>
